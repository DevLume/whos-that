...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Droid.App.MainView, Droid.App", MainView.class, __md_methods);
	}
	...
	public MainView ()
	{
		...
		if (getClass () == MainView.class)
			mono.android.TypeManager.Activate ("Droid.App.MainView, Droid.App", "", this, new java.lang.Object[] {  });
	}
